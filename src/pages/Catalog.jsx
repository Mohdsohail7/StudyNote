...
import { getCategoryPageData } from '../services/operations/pageAndCategoryData';
...
const Catalog = () => {
    ...
    useEffect(() => {
        const getCategories = async() => {
            ...
            const category_id = res?.data?.data?.filter((ctId) => ctId.name.split(" ").join("-").toLowerCase() === catalogName)[0]._id;
