  ...
  return (
    ...
    {/* Course Title */}
        <div className="flex flex-col space-y-2">
            <label className="text-sm text-richblack-5" htmlFor="courseTitle">Course Title<sub className="text-pink-200">*</sub></label>
            <input
                id='courseTitle'
        ...
        <div className="flex flex-col space-y-2">
            <label className="text-sm text-richblack-5" htmlFor="courseShortDesc">Course Short Description<sub className="text-pink-200">*</sub></label>
